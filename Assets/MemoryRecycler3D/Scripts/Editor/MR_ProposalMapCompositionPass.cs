...
public static class MR_ProposalMapCompositionPass
{
    ...
    {
        CreateBox(root, "Central Ring Road", new Vector3(0f, 0.025f, 8f), Vector3.zero, new Vector3(23f, 0.05f, 23f), mats.road);
        CreateBox(root, "Central Archive Plaza", new Vector3(0f, 0.055f, 8f), Vector3.zero, new Vector3(10.5f, 0.06f, 10.5f), mats.darkPanel);
        CreateBox(root, "South Entry Road", new Vector3(0f, 0.065f, -9f), Vector3.zero, new Vector3(6.2f, 0.07f, 30f), mats.roadPatch);
        CreateBox(root, "Residential Spur Road", new Vector3(-10.5f, 0.07f, -5.5f), new Vector3(0f, 24f, 0f), new Vector3(4.6f, 0.07f, 15f), mats.roadPatch);
        CreateBox(root, "School Spur Road", new Vector3(-13.7f, 0.07f, 7.2f), new Vector3(0f, -28f, 0f), new Vector3(4.3f, 0.07f, 14f), mats.roadPatch);
        CreateBox(root, "Admin Spur Road", new Vector3(12.3f, 0.07f, 6.5f), new Vector3(0f, 28f, 0f), new Vector3(4.3f, 0.07f, 14f), mats.roadPatch);
        CreateBox(root, "Outer Ruins Path", new Vector3(4.2f, 0.075f, 20.3f), new Vector3(0f, -16f, 0f), new Vector3(5f, 0.07f, 20f), mats.roadPatch);
    }
    ...
    private static void BuildResidentialMemory(Transform root, Materials mats)
    {
        ...
        CreateBox(group, "Broken Dining Table", new Vector3(-13.5f, 0.65f, -7.0f), Vector3.zero, new Vector3(2.0f, 0.16f, 1.25f), mats.boards);
        for (int i = 0; i < 4; i++)
        {
    ...
    private static void BuildSchoolMemory(Transform root, Materials mats)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            CreateBox(group, "Empty Desk", new Vector3(-17.8f + i * 1.2f, 0.65f, 6.0f + i * 0.22f), new Vector3(0f, -12f, 0f), new Vector3(0.85f, 0.15f, 0.55f), mats.boards);
    ...
    private static void BuildHospitalMemory(Transform root, Materials mats)
    {
        ...
        CreateBox(group, "Treatment Bed", new Vector3(13.0f, 0.58f, -8.0f), new Vector3(0f, 20f, 0f), new Vector3(2.25f, 0.22f, 0.85f), mats.lightPanel);
    ...
    private static void BuildPlayerFileMemory(Transform root, Materials mats)
    {
        ...
        CreateBox(group, "Locked Archive Cabinet", new Vector3(4.5f, 0.9f, 23.5f), new Vector3(0f, 18f, 0f), new Vector3(1.1f, 1.55f, 0.7f), mats.darkPanel);
    ...
    private static void BuildArchiveLullabyMemory(Transform root, Materials mats)
    {
        ...
        CreateCylinder(group, "Archive Lullaby Pedestal", new Vector3(0f, 0.42f, 12.4f), Vector3.zero, new Vector3(1.15f, 0.42f, 1.15f), mats.darkPanel);
    ...
    {
        PlacePrefab(scene, root, "Proposal Ruined Apartments Residential", "Assets/MemoryRecycler3D/ExternalAssets/Tripo/Buildings/RuinedApartmentBuilding/RuinedApartmentBuilding.fbx", new Vector3(-24f, 0f, -8f), new Vector3(0f, 24f, 0f), 8.5f);
        PlacePrefab(scene, root, "Proposal School Korean Ruin", "Assets/MemoryRecycler3D/ExternalAssets/Tripo/Buildings/KoreanRuinedBuilding/KoreanRuinedBuilding.fbx", new Vector3(-25f, 0f, 9f), new Vector3(0f, 42f, 0f), 7.8f);
        PlacePrefab(scene, root, "Proposal Hospital Concrete Ruin", "Assets/MemoryRecycler3D/ExternalAssets/Tripo/Buildings/RuinedConcreteBuilding/RuinedConcreteBuilding.fbx", new Vector3(24f, 0f, -8f), new Vector3(0f, -28f, 0f), 8.2f);
        PlacePrefab(scene, root, "Proposal Admin Tower", "Assets/MemoryRecycler3D/ExternalAssets/Tripo/Buildings/PostApocalypticTower/PostApocalypticTower.fbx", new Vector3(25f, 0f, 9f), new Vector3(0f, -36f, 0f), 7.2f);
        PlacePrefab(scene, root, "Proposal Outer City Block", "Assets/MemoryRecycler3D/ExternalAssets/Tripo/Buildings/RuinedCityBlock/RuinedCityBlock.fbx", new Vector3(0f, 0f, 32f), new Vector3(0f, 180f, 0f), 8.8f);
        PlacePrefab(scene, root, "Proposal Rubble Residential", "Assets/MemoryRecycler3D/ExternalAssets/Tripo/Environment/ConcreteRubble/ConcreteRubble.fbx", new Vector3(-10.4f, 0f, -11.4f), new Vector3(0f, -20f, 0f), 2.8f);
        PlacePrefab(scene, root, "Proposal Recycling Sign Gate", "Assets/MemoryRecycler3D/ExternalAssets/Tripo/Props/RecyclingSigns/RecyclingSigns.fbx", new Vector3(0f, 0f, -14.8f), new Vector3(0f, 0f, 0f), 2.4f);
    }
    ...
    private static GameObject CreateBox(Transform parent, string name, Vector3 position, Vector3 euler, Vector3 scale, Material material)
    {
        return CreatePrimitive(parent, name, PrimitiveType.Cube, position, euler, scale, material);
    }

    private static GameObject CreateCylinder(Transform parent, string name, Vector3 position, Vector3 euler, Vector3 scale, Material material)
    {
        return CreatePrimitive(parent, name, PrimitiveType.Cylinder, position, euler, scale, material);
    }

    private static GameObject CreateSphere(Transform parent, string name, Vector3 position, Vector3 euler, Vector3 scale, Material material)
    {
        return CreatePrimitive(parent, name, PrimitiveType.Sphere, position, euler, scale, material);
    }

    private static GameObject CreatePrimitive(Transform parent, string name, PrimitiveType primitive, Vector3 position, Vector3 euler, Vector3 scale, Material material)
    {
